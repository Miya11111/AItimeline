...
const avatarImages = [
  ...
  require('@/assets/icon9.jpg'),
  require('@/assets/icon10.jpg'),
  require('@/assets/icon11.jpg'),
  require('@/assets/icon12.jpg'),
  require('@/assets/icon13.jpg'),
  require('@/assets/icon14.jpg'),
  require('@/assets/icon15.jpg'),
  require('@/assets/icon16.png'),
  require('@/assets/icon17.jpg'),
  require('@/assets/icon18.jpg'),
  require('@/assets/icon19.jpg'),
  require('@/assets/icon20.jpg'),
  require('@/assets/icon21.png'),
  require('@/assets/icon22.png'),
  require('@/assets/icon23.png'),
  require('@/assets/icon24.png'),
  require('@/assets/icon25.png'),
  require('@/assets/icon26.png'),
  require('@/assets/icon27.png'),
  require('@/assets/icon28.png'),
  require('@/assets/icon29.png'),
  require('@/assets/icon30.png'),
  require('@/assets/icon31.png'),
  require('@/assets/icon32.png'),
  require('@/assets/icon33.jpg'),
  require('@/assets/icon34.png'),
  require('@/assets/icon35.jpg'),
  require('@/assets/icon36.jpg'),
  require('@/assets/icon37.jpg'),
  require('@/assets/icon38.jpg'),
  require('@/assets/icon39.jpg'),
  require('@/assets/icon40.jpg'),
  require('@/assets/icon41.jpg'),
];
